<template>
	<section id="feature" class="features-area section-padding section">
		<div class="container">
			<div class="row">
				<div class="col-12">
			...
			<div class="row feature-item-inner feature-item-inner__left align-items-center">
				...
				<div class="col-lg-4 col-md-6">
					<div v-for="(feature, features) in features" :key="features"
						 class="feature-item feature-item__left">
				...
				<div class="col-lg-4 order-3 order-lg-2">
					<div class="feature-middle-thumb">
						<img alt="feature thumb" src="../static/img/feature4.png">
					</div>
				</div>
				<!-- feature thumb  -->
				...
				<div class="col-lg-4 col-md-6 order-2 order-lg-3">
					<div v-for="(feature2, features2) in features2" :key="features2"
						 class="feature-item feature-item__right">
						<div class="feature-icon">
...
@import '../static/scss/components/feature.scss';
</style>
