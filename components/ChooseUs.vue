<template>
	<div id="chooseus" class="whyus-area section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
			...
			<div class="whyus row">
				...
				<div v-for="(item, index) in whyus" :key="index" class="col-md-6 col-lg-3">
					<div class="sin-whyus">
...
export default {
	...
	data() {
		return {
			whyus: [
				{
					icon: require('../static/img/hosting/whyus/1.png'),
					title: 'Everyday Backups',
					desc: 'Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem.'
				},
				{
					icon: require('../static/img/hosting/whyus/2.png'),
					title: 'WORKING 24/7',
					desc: 'Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem.'
				},
				{
					icon: require('../static/img/hosting/whyus/3.png'),
					title: 'HIQUALITY EQUIPMENT',
					desc: 'Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem.'
				},
				{
					icon: require('../static/img/hosting/whyus/4.png'),
...
.whyus-area {
	background: url('../static/img/hosting/whyus/whyus-bg.jpg');
