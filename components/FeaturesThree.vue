<template>
	<section id="feature" :style="bgImg" class="features-area fix feature-style-3 bg-cover section">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-7 col-md-6 order-2 order-md-1">
					<div class="feature-thumb pt-30">
						<img alt="feature thumb" src="../static/img/feature3.png">
					</div>
				</div>
...
export default {
	...
	data() {
		return {
			...
			bgImg: {
				backgroundImage: `url(${require('../static/img/bg/feature3-bg.jpg')})`
			}
		}
	}
}
