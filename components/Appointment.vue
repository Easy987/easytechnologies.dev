<template>
	<section id="appointment" class="appointment-area section-padding section">
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<div class="appointment-form">
						...
						<form class="appointment-box">
							<input class="appointment-field" placeholder="Name" type="text">
							<input class="appointment-field" placeholder="Email" type="text">
							...
							<textarea class="textarea-field" placeholder="Message"></textarea>
...
export default {
	...
	data() {
		return {
			provides: [
				{
					icon: require("../static/img/home-medical/provide/1.png"),
					title: 'HEALTHY PLANS',
					desc: 'Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.'
				},
				{
					icon: require("../static/img/home-medical/provide/2.png"),
					title: 'PRIVATE SUPPORT',
					desc: 'Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.'
				},
				{
					icon: require("../static/img/home-medical/provide/3.png"),
					title: 'WELL CARED',
					desc: 'Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.'
				},
				{
					icon: require("../static/img/home-medical/provide/4.png"),
