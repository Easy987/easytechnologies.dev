<template>
	<section id="pricing" class="pricing-hosting section-padding">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				<div v-for="(pricing, index) in pricingTable" :key="index" class="col-lg-3 col-md-6">
					<div :class="{'active': pricing.active}" class="price-item price-item--hosting mx-0">
						...
						<div class="price-footer">
							<button :class="{'btn-2--bg': pricing.active}" class="btn btn-round btn-2">Ordedr Now
							</button>
						</div>
					</div>
				</div>
