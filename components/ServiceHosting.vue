<template>
	<section id="service" class="service-hosting section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
...
export default {
	...
	data() {
		return {
			services: [
				{
					icon: require('../static/img/hosting/icon/1.png'),
					title: 'Firewall',
				...
				{
					icon: require('../static/img/hosting/icon/2.png'),
					title: 'Data Enctyption',
					desc: 'Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.'
				},
				{
					icon: require('../static/img/hosting/icon/3.png'),
					title: 'Data Analysis',
					desc: 'Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.'
				},
				{
					icon: require('../static/img/hosting/icon/4.png'),
					title: 'Technical Service',
					desc: 'Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.'
				},
				{
					icon: require('../static/img/hosting/icon/5.png'),
					title: 'Data Protection',
					desc: 'Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.'
				},
				{
					icon: require('../static/img/hosting/icon/6.png'),
					title: 'Monitoring',
					desc: 'Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.'
				},
			]
