<template>
	<div id="about" class="about-hosting section-padding">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-xl-7">
					<div class="image">
						<img alt="about thumb" src="../static/img/hosting/about/about.png"/>
						<div class="sin-fact">
							<img alt="about icon" src="../static/img/hosting/about/1.png"/>
							<div>
						...
						<div class="sin-fact">
							<img alt="about icon" src="../static/img/hosting/about/2.png"/>
							<div>
						...
						<div class="sin-fact">
							<img alt="about icon" src="../static/img/hosting/about/3.png"/>
							<div>
