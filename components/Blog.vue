<template>
	<section id="blog" class="latest-blog-area section-padding section">
		<div class="container">
			<div class="row">
				<div class="col-12">
...
export default {
	...
	data() {
		return {
			blogs: [
				{
					thumb: require("../static/img/home-medical/blog/1.jpg"),
					date: '14 FEB',
					icon: 'fa fa-comment',
					comment: '12',
				...
				{
					thumb: require("../static/img/home-medical/blog/2.jpg"),
					date: '18 JUN',
					icon: 'fa fa-comment',
					comment: '32',
				...
				{
					thumb: require("../static/img/home-medical/blog/3.jpg"),
					date: '16 MAR',
					icon: 'fa fa-comment',
					comment: '10',
