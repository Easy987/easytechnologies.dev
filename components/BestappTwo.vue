<template>
	<section :style="bgImg" class="best-app-area section-padding2 pb-0 fix">
		<div class="container">
			<div class="row">
				<div class="col-xl-6 col-lg-6">
					<div class="bestapp-content-inner bestappTwo">
				...
				<div class="col-xl-6 col-lg-6">
					<div class="bestapp-thumb">
						<img alt="bestapp thumb" src="../static/img/bestapp2.png">
					</div>
				</div>
			</div>
		</div>
...
export default {
	...
	data() {
		return {
			bgImg: {
				backgroundImage: `url(${require('../static/img/bestapp2-bg.jpg')})`
			}
		}
	}
}
