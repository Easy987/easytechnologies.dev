	...
	<section class="about-app-store">
		<div class="container-fluid p-0">
			<div class="row no-gutters">
				<div class="col-lg-6">
					<div :style="bgImg" class="about-app section-padding bg-cover">
						...
						<div class="about-app-content text-center">
							...
							<a class="read-more round-gradient" href="#">Read More</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
...
export default {
	...
	data() {
		return {
			bgImg: {
				backgroundImage: `url(${require('../static/img/bg/info-left-bg.jpg')})`
			}
		}
	}
}
