<template>
	<section :style="bgImg" class="video-section section-padding fix">
		<div class="container">
			<div class="row">
				<div class="col-12">
...
export default {
	...
	data() {
		return {
			...
			bgImg: {
				backgroundImage: `url(${require('../static/img/bg/video-bg.jpg')})`
			}
		}
	}
}
...
@import '../static/scss/components/video.scss';
</style>
